...
from models.models_3d.embedding import EmbeddingBag
...
class Chytorch2D(Module):
    ...
    def forward(self, 
        ...
        self.max_distance = 10  # param for MoleculeEncoder
        ...
        for i in range(num_batches):
            ...
            adjacency_matrix = (dist<2)*1
            dist = shortest_path(adjacency_matrix, method='FW', directed=False, unweighted=True) + 2
